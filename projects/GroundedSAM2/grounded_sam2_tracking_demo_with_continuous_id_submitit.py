...
def track_objects_in_video(args):
    ...
    # video_dir = '/vhome/xieyiweng/Grounded-SAM-2/custom_video_frames'
    ...
    create_video_from_images(result_dir, output_video_path, frame_rate=24)

def get_config():
    parser = argparse.ArgumentParser(description='GS', add_help=False)
