...
from detectron2.projects.uninext.data.coco_dataset_mapper_uni import (
    create_queries_and_maps,
)
from detectron2.projects.uninext.data.objects365_v2 import (
    categories as OBJECTS365V2_CATEGORIES,
)
    ...
    def __call__(self, original_image, task, expressions=None):
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            if task == "detection":
                ...
                positive_map_label_to_token = (
                    self.positive_map_label_to_token_dict[dataset_name]
                )
                inputs = {
                    "image": image,
                    "height": height,
                ...
                raise ValueError(
                    """Unsupported task. task must be in ["detection", "grounding", "sot"]"""
                )
