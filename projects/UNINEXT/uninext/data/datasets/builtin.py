...
from .flicker import _get_flicker_meta, register_flicker
...
_PREDEFINED_SPLITS_REFCOCO = {
    ...
    "refcoco-unc-train": (
        "coco/train2014",
        "annotations/refcoco-unc/instances_train.json",
    ),
    "refcoco-unc-val": (
        "coco/train2014",
        "annotations/refcoco-unc/instances_val.json",
    ),
    "refcoco-unc-testA": (
        "coco/train2014",
        "annotations/refcoco-unc/instances_testA.json",
    ),
    "refcoco-unc-testB": (
        "coco/train2014",
        "annotations/refcoco-unc/instances_testB.json",
    ),
    # refcocog
    "refcocog-umd-train": (
        "coco/train2014",
        "annotations/refcocog-umd/instances_train.json",
    ),
    "refcocog-umd-val": (
        "coco/train2014",
        "annotations/refcocog-umd/instances_val.json",
    ),
    "refcocog-umd-test": (
        "coco/train2014",
        "annotations/refcocog-umd/instances_test.json",
    ),
    "refcocog-google-val": (
        "coco/train2014",
        "annotations/refcocog-google/instances_val.json",
    ),
    # refcoco+
    "refcocoplus-unc-train": (
        "coco/train2014",
        "annotations/refcocoplus-unc/instances_train.json",
    ),
    "refcocoplus-unc-val": (
        "coco/train2014",
        "annotations/refcocoplus-unc/instances_val.json",
    ),
    "refcocoplus-unc-testA": (
        "coco/train2014",
        "annotations/refcocoplus-unc/instances_testA.json",
    ),
    "refcocoplus-unc-testB": (
        "coco/train2014",
        "annotations/refcocoplus-unc/instances_testB.json",
    ),
    # mixed
    "refcoco-mixed": (
        "coco/train2014",
        "annotations/refcoco-mixed/instances_train.json",
    ),
    "refcoco-mixed-filter": (
        "coco/train2014",
        "annotations/refcoco-mixed/instances_train_filter.json",
    ),
}
...
_PREDEFINED_SPLITS_FLICKER = {
    ...
    "flicker-train": (
        "flickr30k-images",
        "OpenSource/final_flickr_separateGT_train.json",
    ),
}
...
_PREDEFINED_SPLITS_YTVIS_2019 = {
    ...
    "ytvis_2019_dev": ("ytvis_2019/train/JPEGImages", "ytvis_2019/train.json"),
}
...
_PREDEFINED_SPLITS_OVIS = {
    "ytvis_ovis_train": ("ovis/train", "ovis/annotations_train.json"),
    "ytvis_ovis_val": ("ovis/valid", "ovis/annotations_valid.json"),
    "ytvis_ovis_train_sub": ("ovis/train", "ovis/ovis_sub_train.json"),
    "ytvis_ovis_val_sub": ("ovis/train", "ovis/ovis_sub_val.json"),
}
...
_PREDEFINED_SPLITS_COCO_VIDS = {
    "coco_2017_train_video": (
        "coco/train2017",
        "coco/annotations/instances_train2017_video.json",
    ),
    "coco_2017_val_video": (
        "coco/val2017",
        "coco/annotations/instances_val2017_video.json",
    ),
}
...
_PREDEFINED_SPLITS_REFYTBVOS = {
    "rvos-refcoco-mixed": (
        "coco/train2014",
        "annotations/refcoco-mixed/instances_train_video.json",
    ),
    "rvos-refytb-train": (
        "ref-youtube-vos/train/JPEGImages",
        "ref-youtube-vos/train.json",
    ),
    "rvos-refytb-val": (
        "ref-youtube-vos/valid/JPEGImages",
        "ref-youtube-vos/valid.json",
    ),
    "rvos-refdavis-val-0": (
        "ref-davis/valid/JPEGImages",
        "ref-davis/valid_0.json",
    ),
    "rvos-refdavis-val-1": (
        "ref-davis/valid/JPEGImages",
        "ref-davis/valid_1.json",
    ),
    "rvos-refdavis-val-2": (
        "ref-davis/valid/JPEGImages",
        "ref-davis/valid_2.json",
    ),
    "rvos-refdavis-val-3": (
        "ref-davis/valid/JPEGImages",
        "ref-davis/valid_3.json",
    ),
}
...
_PREDEFINED_SPLITS_BDD_OBJ_DET = {
    "bdd_det_train": (
        "bdd/images/100k/train",
        "bdd/labels/det_20/det_train_cocofmt_uni.json",
    ),
    "bdd_det_val": (
        "bdd/images/100k/val",
        "bdd/labels/det_20/det_val_cocofmt_uni.json",
    ),
}
...
_PREDEFINED_SPLITS_BDD_INST_SEG = {
    "bdd_inst_train": (
        "bdd/images/10k/train",
        "bdd/labels/ins_seg/polygons/ins_seg_train_cocoformat_uni.json",
    ),
    "bdd_inst_val": (
        "bdd/images/10k/val",
        "bdd/labels/ins_seg/polygons/ins_seg_val_cocoformat_uni.json",
    ),
}
...
_PREDEFINED_SPLITS_BDD_BOX_TRACK = {
    "bdd_box_track_train": (
        "bdd/images/track/train",
        "bdd/labels/box_track_20/box_track_train_cocofmt_uni.json",
    ),
    "bdd_box_track_val": (
        "bdd/images/track/val",
        "bdd/labels/box_track_20/box_track_val_cocofmt_uni.json",
    ),
}
...
_PREDEFINED_SPLITS_BDD_SEG_TRACK = {
    "bdd_seg_track_train": (
        "bdd/images/seg_track_20/train",
        "bdd/labels/seg_track_20/seg_track_train_cocoformat_uni.json",
    ),
    "bdd_seg_track_val": (
        "bdd/images/seg_track_20/val",
        "bdd/labels/seg_track_20/seg_track_val_cocoformat_uni.json",
    ),
}
...
def register_all_bdd_box_track(root):
    for key, (
        image_root,
        json_file,
    ) in _PREDEFINED_SPLITS_BDD_BOX_TRACK.items():
        # Assume pre-defined datasets live in `./datasets`.
        register_ytvis_instances(
            key,
            _get_bdd_obj_track_meta(),
...
def register_all_bdd_seg_track(root):
    for key, (
        image_root,
        json_file,
    ) in _PREDEFINED_SPLITS_BDD_SEG_TRACK.items():
        # Assume pre-defined datasets live in `./datasets`.
        register_ytvis_instances(
            key,
            _get_bdd_obj_track_meta(),
...
def register_all_bdd_det_trk_mix(root):
    for key, (
        image_root,
        json_file,
    ) in _PREDEFINED_SPLITS_BDD_DET_TRK_MIXED.items():
...
_PREDEFINED_SPLITS_SOT = {
    ...
    "sot_lasot_ext_test": (
        ...
        "LaSOT_extension_subset/test.json",
    ),
    "sot_trackingnet_train": ("TrackingNet2", "TrackingNet2/TRAIN.json"),
    "sot_trackingnet_test": ("TrackingNet2", "TrackingNet2/TEST.json"),
    "sot_coco_2017_train": (
        "coco/train2017",
        "coco/annotations/instances_train2017_video_sot.json",
    ),
    "sot_coco_2017_val": (
        "coco/val2017",
        "coco/annotations/instances_val2017_video_sot.json",
    ),
    "sot_ytbvos18_train": (
        "ytbvos18/train/JPEGImages",
        "ytbvos18/train/train.json",
    ),
