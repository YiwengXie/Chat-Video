...
class RetinaNet(DenseDetector):
    ...
    def from_config(cls, cfg):
        ...
        feature_shapes = [
            backbone_shape[f] for f in cfg.MODEL.RETINANET.IN_FEATURES
        ]
    ...
    def losses(
        self, anchors, pred_logits, gt_labels, pred_anchor_deltas, gt_boxes
    ):
        """
        Args:
...
class RetinaNetHead(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: List[ShapeSpec]):
        ...
        return {
            ...
            "num_classes": cfg.MODEL.RETINANET.NUM_CLASSES,
            "conv_dims": [input_shape[0].channels]
            * cfg.MODEL.RETINANET.NUM_CONVS,
