...
class ProtobufDetectionModel(torch.nn.Module):
    ...
    def __init__(self, predict_net, init_net, *, convert_outputs=None):
        ...
        self.size_divisibility = get_pb_arg_vali(
            predict_net, "size_divisibility", 0
        )
        self.device = get_pb_arg_vals(predict_net, "device", b"cpu").decode(
            "ascii"
        )
        ...
        if convert_outputs is None:
            ...
            meta_arch = META_ARCH_CAFFE2_EXPORT_TYPE_MAP[
                meta_arch.decode("ascii")
            ]
