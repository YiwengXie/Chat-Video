...
class _DatasetCatalog(UserDict):
    ...
    def register(self, name, func):
        ...
        assert name not in self, "Dataset '{}' is already registered!".format(
            name
        )
        self[name] = func
    ...
    def __str__(self):
        return "DatasetCatalog(registered datasets: {})".format(
            ", ".join(self.keys())
        )
...
class _MetadataCatalog(UserDict):
    ...
    def __str__(self):
        return "MetadataCatalog(registered metadata: {})".format(
            ", ".join(self.keys())
        )
